package uk.easys.easymarketing.webview;
...
public class AdvancedWebView extends WebView {
    ...
    public void setListener(final Fragment fragment, final Listener listener, final int requestCodeFilePicker) {
        if (fragment != null) mFragment = new WeakReference<Fragment>(fragment);
        else mFragment = null;
    ...
    protected void setGeolocationDatabasePath() {
        ...
        else if (mActivity != null && mActivity.get() != null) activity = mActivity.get();
        else return;
    ...
    public void onResume() {
        if (Build.VERSION.SDK_INT >= 11) super.onResume();
        resumeTimers();
    }
    ...
    public void onPause() {
//		pauseTimers();
        if (Build.VERSION.SDK_INT >= 11) super.onPause();
    }
    ...
    protected void init(Context context) {
        ...
        if (Build.VERSION.SDK_INT < 19) webSettings.setDatabasePath(databaseDir);
        ...
        super.setWebViewClient(new WebViewClient() {
            ...
            public void onPageStarted(WebView view, String url, Bitmap favicon) {
                if (!hasError()) if (mListener != null) mListener.onPageStarted(url, favicon);
            ...
            public void onPageFinished(WebView view, String url) {
                if (!hasError()) if (mListener != null) mListener.onPageFinished(url);

                if (mCustomWebViewClient != null) mCustomWebViewClient.onPageFinished(view, url);
            }
            ...
            public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
                ...
                if (mListener != null) mListener.onPageError(errorCode, description, failingUrl);
...
//			}
        ...
        super.setWebChromeClient(new WebChromeClient() {
            ...
            public void onHideCustomView() {
                if (mCustomWebChromeClient != null) mCustomWebChromeClient.onHideCustomView();
            ...
            public void onRequestFocus(WebView view) {
                if (mCustomWebChromeClient != null) mCustomWebChromeClient.onRequestFocus(view);
                else super.onRequestFocus(view);
            }

            @Override
            public void onCloseWindow(WebView window) {
                if (mCustomWebChromeClient != null) mCustomWebChromeClient.onCloseWindow(window);
            ...
            public boolean onJsTimeout() {
                if (mCustomWebChromeClient != null) return mCustomWebChromeClient.onJsTimeout();
            ...
            public void onReachedMaxAppCacheSize(long requiredStorage, long quota, QuotaUpdater quotaUpdater) {
                ...
                else super.onReachedMaxAppCacheSize(requiredStorage, quota, quotaUpdater);
            }
    ...
    public void loadUrl(final String url, Map<String, String> additionalHttpHeaders) {
        ...
        else if (mHttpHeaders.size() > 0) additionalHttpHeaders.putAll(mHttpHeaders);
    ...
    public void loadUrl(final String url) {
        if (mHttpHeaders.size() > 0) super.loadUrl(url, mHttpHeaders);
        else super.loadUrl(url);
    }

    public void loadUrl(String url, final boolean preventCaching) {
        if (preventCaching) url = makeUrlUnique(url);
        loadUrl(url);
    }
    ...
    protected static String makeUrlUnique(final String url) {
        ...
        if (url.contains("?")) unique.append('&');
        else {
            if (url.lastIndexOf('/') <= 7) unique.append('/');
            unique.append('?');
        }
    ...
    protected void openFileInput(final ValueCallback<Uri> fileUploadCallbackFirst, final ValueCallback<Uri[]> fileUploadCallbackSecond,
        ...
        if (mFileUploadCallbackFirst != null) mFileUploadCallbackFirst.onReceiveValue(null);
        mFileUploadCallbackFirst = fileUploadCallbackFirst;

        if (mFileUploadCallbackSecond != null) mFileUploadCallbackSecond.onReceiveValue(null);
    ...
    public static class Browsers {
        ...
        public static void openUrl(final Activity context, final String url, final boolean withoutTransition) {
            ...
            if (withoutTransition) context.overridePendingTransition(0, 0);
        }
